package com.fadiquader.springlearning.business;

import com.fadiquader.springlearning.data.*;
...
//    @Autowired: optional, you use it when there's more than one constructor
